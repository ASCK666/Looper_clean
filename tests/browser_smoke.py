...
with tempfile.TemporaryDirectory() as td, contextlib.ExitStack() as stack:
    ...
    with sync_playwright() as p:
        ...
        assert page.locator('.cassetteMechanism').evaluate("el=>getComputedStyle(el,'::before').backgroundImage.includes('cassette-cavity.svg') && getComputedStyle(el,'::after').content==='none'")
