...
assert './css/base.css?v=looper66-mobile-transport-1' in HTML
...
assert re.search(r'\.deckHotspot::before\s*\{[^}]*background-image:var\(--transport-light-image,url\("\.\./assets/looper-ui/looper66-transport\.webp"\)\);[^}]*background-size:var\(--transport-light-size\);[^}]*box-shadow:none;[^}]*mix-blend-mode:screen;',CSS)
