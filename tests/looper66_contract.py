...
assert re.search(r'<img\b[^>]*class="looper66CassetteSupport"[^>]*src="assets/looper-ui/120927/cassette-support\.webp"[^>]*width="550"[^>]*height="366"',HTML)
...
assert (ROOT/'assets/looper-ui/120927/cassette-support.webp').exists()
